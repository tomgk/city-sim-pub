 ...
 * @author Thomas
 */
public class Vacant extends Structure<Vacant, VacantType, VacantType.Variant, PlainStructureParameters>
{   
    ...
    public Vacant(VacantType type, int x, int y, VacantType.Variant version, PlainStructureParameters data)
    {
